...
class NavigationExtension extends AbstractExtension
{
    ...
    {
        return [
            new TwigFunction('helperbundle_navigation_data_links', [$this, 'getDataLinks']),
            new TwigFunction('helperbundle_navigation_enrich_breadcrumbs', [$this, 'enrichBreadcrumbs'])
        ];
    }
