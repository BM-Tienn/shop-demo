...
class LanguageSwitcherExtension extends AbstractExtension
{
    ...
    public function getLocalizedLinks(Document $document): array
    {
        ...
        foreach (Tool::getValidLanguages() as $language) {
            ...
            if ($route && $routeParams && count($routeParams) > 2) {
                $routeParams['path'] = substr($target, 1);
    ...
    {
        return [
            new TwigFunction('helperbundle_localized_links', [$this, 'getLocalizedLinks']),
            new TwigFunction('helperbundle_language_flag', [$this, 'getLanguageFlag'])
        ];
    }
