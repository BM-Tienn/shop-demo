 ...
 * @method DataObject\LinkActivityDefinition[] getObjects()
 */
...
* @return $this
*/
public function filterByAttributeType ($data, $operator = '='): static
{
...
* @return $this
*/
public function filterByUtm_source ($data, $operator = '='): static
{
...
* @return $this
*/
public function filterByUtm_medium ($data, $operator = '='): static
{
...
* @return $this
*/
public function filterByUtm_campaign ($data, $operator = '='): static
{
...
* @return $this
*/
public function filterByUtm_term ($data, $operator = '='): static
{
...
* @return $this
*/
public function filterByUtm_content ($data, $operator = '='): static
{
