...
{
	$this->markFieldDirty("defaultOrderByInheritance", true);
...
{
	$this->markFieldDirty("orderByAsc", true);
...
{
	$this->markFieldDirty("orderByDesc", true);
...
{
	$this->markFieldDirty("ajaxReload", true);
...
{
	$this->markFieldDirty("infiniteScroll", true);
...
{
	$this->markFieldDirty("conditionsInheritance", true);
...
{
	$this->markFieldDirty("filtersInheritance", true);
...
{
	$this->markFieldDirty("similarityFieldsInheritance", true);
