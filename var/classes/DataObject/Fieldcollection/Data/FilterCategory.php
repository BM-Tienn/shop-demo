...
public const FIELD_PRE_SELECT = 'preSelect';
public const FIELD_ROOT_CATEGORY = 'rootCategory';
public const FIELD_INCLUDE_PARENT_CATEGORIES = 'includeParentCategories';
public const FIELD_SCRIPT_PATH = 'scriptPath';
public const FIELD_AVAILABLE_CATEGORIES = 'availableCategories';
